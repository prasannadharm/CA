...
{
    public class ClientGroupMasterDAO
    {
        public List<ClientGroupMasterEntity> GetClientGroupList()
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("USP_GetClientGroupList", con);
        ...
        public List<ClientGroupMasterEntity> EditClientGroup(int id)
        {
            string CS = ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString;
            SqlDataAdapter adapter;
            DataSet ds = new DataSet();
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(CS))
                {
                    SqlCommand cmd = new SqlCommand("USP_GetClientGroupDetailsbyID", con);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DbStatusEntity UpdateClientGroup(ClientGroupMasterEntity obj, int id)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(CS))
                {
                    SqlCommand cmd = new SqlCommand("USP_UpdateClientGroupMaster", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@CLI_GRP_ID", id);
                    cmd.Parameters.AddWithValue("@CLI_GRP_NAME", obj.CLI_GRP_NAME);
        ...
        public DbStatusEntity InsertClientGroup(ClientGroupMasterEntity obj)
        {
            DbStatusEntity objreturn = new DbStatusEntity();
            string CS = ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(CS))
                {
                    SqlCommand cmd = new SqlCommand("USP_InsertClientGroupMaster", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@CLI_GRP_NAME", obj.CLI_GRP_NAME);
                    cmd.Parameters.AddWithValue("@ACTIVE_STATUS", obj.ACTIVE_STATUS);
        ...
        public DbStatusEntity DeleteClientGroup(int id)
        {
            DbStatusEntity objreturn = new DbStatusEntity();
            string CS = ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(CS))
                {
                    SqlCommand cmd = new SqlCommand("USP_DeleteClientGroupMaster", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id);
