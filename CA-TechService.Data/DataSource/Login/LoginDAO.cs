...
using CA_TechService.Data.Query.Login;
using System;
    ...
    public class LoginDAO
    {
        ...
        public LoginEntity CheckLogin(LoginEntity objLogin)
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                SqlCommand cmd = new SqlCommand(LoginQueries.CheckLogin, con);
        ...
        public List<UserMenuEntity> GetMenuForUser(int UserID)
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                SqlCommand cmd = new SqlCommand(LoginQueries.GetMenuForUser, con);
                cmd.CommandType = CommandType.StoredProcedure;
                con.Open();
