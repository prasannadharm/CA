<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ClientGroup.aspx.cs" Inherits="CA_TechServices.Pages.ClientMaster.ClientGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="../../Scripts/app/clientgroup.js"></script>
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="row">
                <div class="col-6">
                    <h2>Client Group Master</h2>
                </div>
                <div class="col-6">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2>Edit Client Group Details</h2>
                ...
                <div class="modal-body">
                    <div class="panel-body">
                        <div class="form-group col-lg-12">
                            ...
                            <input type="text" name="CLI_GRP_NAME" id="CLI_GRP_NAME1" class="form-control" placeholder="Please enter Client group name"/>                            
                        </div>
                        <div class="form-group col-lg-12">
